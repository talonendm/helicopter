...
textFont(font, floor(kuvaleveys/130));
textAlign(LEFT);
...
fill(0, 222, 0);
textAlign(RIGHT);
text("2 player: arrow keys or 4) more gas, 1) less gas, 2) turn left, 3) turn right, 5/SHIFT) turn around, ENTER) FIRE!!!",kuvaleveys*0.99,kuvakorkeus*0.4);
text("(mouse activate & automate green helicopter (1 player game): click the sun)",kuvaleveys*0.99,kuvakorkeus*0.8);

textFont(font, floor(kuvaleveys/70));
fill(255, 255, 255);
textAlign(CENTER);
